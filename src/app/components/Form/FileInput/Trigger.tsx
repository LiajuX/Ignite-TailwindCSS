...
export function Trigger() {
  ...
  return (
    <label
      htmlFor={id}
      className={twMerge(
        'group flex w-full flex-1 cursor-pointer flex-col items-center gap-3 rounded-lg border border-zinc-200 px-6 py-4 text-center text-zinc-500 shadow-sm',
    ...
    >
      <div
        className={twMerge(
          ...
          'dark:border-zinc-700 dark:bg-zinc-800 dark:group-hover:border-zinc-600 dark:group-hover:bg-zinc-600',
        )}
      >
